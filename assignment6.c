...
void registration();
void lobby();
int emailValidation(char userEmail[50]);
...
void login(){
    ...
    correctEmail = emailValidation(lEmail);

    eFound = -1;
    myStrCmp(correctEmail);
...
void registration(){
    ...
    correctEmail = emailValidation(userEmail);
